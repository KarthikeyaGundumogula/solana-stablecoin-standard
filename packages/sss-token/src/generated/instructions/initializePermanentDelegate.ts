...
export type InitializePermanentDelegateAsyncInput<
...
> = {
  ...
  name: InitializePermanentDelegateInstructionDataArgs["name"];
  symbol: InitializePermanentDelegateInstructionDataArgs["symbol"];
  uri: InitializePermanentDelegateInstructionDataArgs["uri"];
  decimals: InitializePermanentDelegateInstructionDataArgs["decimals"];
};

export async function getInitializePermanentDelegateInstructionAsync<
  TAccountAuthority extends string,
  TAccountConfig extends string,
  TAccountMint extends string,
  TAccountTokenProgram extends string,
